...
?>
    <div class="container">
      ...
      <!-- Example row of columns -->
		...
		<blockquote>
			<ul class="unstyled">
				<li><strong><?php echo $this->lang->line('game_date'); ?>: </strong><?php echo date('d/m \a\s G:i\h', strtotime($game->first_row()->date)); ?></li>
				<li><strong><?php echo $this->lang->line('game_present_users'); ?>: </strong><?php echo $CI->radioc_model->get_presence_number($game->first_row()->id) ?></li>
			</ul>
