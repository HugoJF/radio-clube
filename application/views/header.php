        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
				...
				<?php if($this->ion_auth->logged_in()): ?><li class="active"><a href="<?php echo base_url();?>dashboard/"               ><?php echo $this->lang->line('header_index'); ?>         </a></li><?php endif; ?>
            ...
            <div class="navbar-form pull-right">
              <ul class="nav">
				<li><a href="#"><strong><?php if(isset($the_user->username)) echo $the_user->username; ?></strong></a></li>
